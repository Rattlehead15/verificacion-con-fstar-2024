...
let delete_root (t: bst) : Pure bst (requires N? t) (ensures fun _ -> True) (decreases size t) =
  let N (l, _, r) = t in
...
let rec delete_size (x:int) (t:bst) : Lemma (ensures delete x t == t \/ size (delete x t) == size t - 1) (decreases size t) =
  match t with
  | L -> ()
  | N (l, y, r) ->
    delete_size x l;
